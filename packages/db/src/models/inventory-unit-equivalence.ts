...
// ============================================================================
// InventoryUnitEquivalenceModel — Tabla de conversiones aprendidas
// FASE04 §3.3 — Colección: inventory_unit_equivalences
// ============================================================================

export interface IInventoryUnitEquivalenceDocument extends Document {
...
const InventoryUnitEquivalenceSchema =
  new Schema<IInventoryUnitEquivalenceDocument>(
    {
      tenantId: {
...
InventoryUnitEquivalenceSchema.index(
  { tenantId: 1, skuId: 1, fromUnit: 1 },
  { unique: true }
)
