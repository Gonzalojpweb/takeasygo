      ...
      <div className="flex justify-center gap-2 mb-6">
        {digits.map((d, i) => (
          <input
            ...
            className="w-12 h-14 text-center text-2xl font-black rounded-xl border-2 border-zinc-200 focus:border-emerald-500 focus:outline-none transition-all bg-zinc-50"
            autoFocus={i === 0}
          />
        ))}
      </div>
