        ...
        <section id="pricing" className="bg-white py-20 md:py-32 px-5 md:px-6">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 md:mb-16">
                    ...
                    {/* Switcher — reduced padding on mobile to prevent overflow */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 items-stretch justify-center max-w-6xl mx-auto">
