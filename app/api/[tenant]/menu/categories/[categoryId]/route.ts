...
export async function PUT(
  ...
  try {
    ...
    const { locationId, name, description, isAvailable, isBusinessAvailable, imageUrl, availabilityMode, availabilitySchedule, customizationGroups } = await request.json()
