  ...
  return (
    <div className="space-y-6">
      ...
      {showPrintSettings && editingPrintSettings && createPortal(
        <Card className="border-2 border-primary/20 rounded-[2rem] shadow-xl bg-card animate-in fade-in slide-in-from-top-2 duration-300 fixed inset-4 z-[60] flex flex-col max-h-[calc(100vh-2rem)] py-0 gap-0 overflow-hidden">
