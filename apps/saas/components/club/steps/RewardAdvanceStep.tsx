...
export default function RewardAdvanceStep({ accentColor, restaurantName, onNext }: RewardAdvanceStepProps) {
  return (
    <div className="flex flex-col items-center justify-center py-8 px-2">
      ...
      >
        ...
        >
          <Zap size={40} style={{ color: accentColor }} className="fill-current" />
        </div>
      </motion.div>
      ...
      >
        TGO y {restaurantName} te adelantamos los puntos con Reward Advance.
      </motion.p>
      ...
      >
        Si te faltan puntos para un canje, te los adelantamos para que no te lo pierdas.
      </motion.p>
