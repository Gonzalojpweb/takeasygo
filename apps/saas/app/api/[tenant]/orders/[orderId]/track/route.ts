...
export async function POST(
  ...
  try {
      ...
      return NextResponse.json({
        ...
        deliveryProvider: order.deliveryProvider ? {
          ...
          rapiboy: order.deliveryProvider.rapiboy ? {
            ...
            quoteStatus: order.deliveryProvider.rapiboy.quoteStatus,
            checkoutCost: order.deliveryProvider.rapiboy.checkoutCost,
            pendingQuoteCost: order.deliveryProvider.rapiboy.pendingQuoteCost,
            pendingQuoteTimestamp: order.deliveryProvider.rapiboy.pendingQuoteTimestamp,
            transferBuffer: order.deliveryProvider.rapiboy.transferBuffer,
            chargedToCustomer: order.deliveryProvider.rapiboy.chargedToCustomer,
          } : null,
        } : null,
        payment: {
    ...
    } // end if (awaiting_payment && hasMpConfigured)
